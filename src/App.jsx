  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        gap: 4,
        // macOS traffic lights sit in the drag region
        WebkitAppRegion: "drag",
      }}>
        {/* App wordmark */}
        <div style={{ fontSize: 13, fontWeight: 800, color: T.text, letterSpacing: "-0.01em", marginRight: 18, WebkitAppRegion: "no-drag", userSelect: "none", flexShrink: 0 }}>
        ...
        {/* Right side: daily goal + theme + settings */}
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0, WebkitAppRegion: "no-drag" }}>
          ...
          <div style={{
            ...
            <span style={{ color: T.textMuted }}>/ {goal} today</span>
            <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: T.textSub, cursor: "pointer", fontSize: 14,
